...
<div class="container-fluid">
    <div class="row">
        <div class=" col-xs-12 col-md-6  col-lg-6 well-lg">
        ...
        <div class="form col-xs-12 col-md-6 col-lg-6 well-lg " id="formLG">
    ...
    $.ajax({
                                        ...
                                        "url":"' . $actio2 . '",
                                        "data":form.serialize(),
                                        "success":function(data){$(".modal-body,.reservacasaform,.inlinelogin,.xhrResults").html(data);obj = JSON.parse(data);if(obj.status=="700"){
