            ...
            <link rel="shortcut icon" href="/favicon.ico" type="image/x-icon">
                ...
                <![endif]-->
                    ...
                    <body>
                        ...
                        <div id="page" class="container-fluid" lang="<?php echo Yii::app()->getLanguage() ?>">
                                        ...
                                        <li>
                                            ...
                                            <?php if (!Yii::app()->user->isGuest && Yii::app()->user->getState('isAdmin') == 'Back'): ?>
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <?php if (!Yii::app()->user->isGuest): ?>
                                                        <li><img class='thumbnail img-circle' src="https://graph.facebook.com/<?php echo Yii::app()->user->fbid; ?>/picture?type=small"/></li>
                                                    <?php endif; ?>
                                            </ul>
