    ...
    <div class="navbar-default sidebar" role="navigation">
        ...
        <div class="sidebar-nav navbar-collapse" id="collapse-2">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="active" href="<?php echo Yii::app()->createUrl('site/dashboard') ?>"> Dashboard<span class="glyphicon glyphicon-bell icon-love pull-right">(<?php echo Casa::model()->dashboardAlerts(); ?>)</span></a>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li>
                            <a href="<?php echo Yii::app()->createUrl('feedback/admin') ?>">Gerir Pagamentos</a>
                        </li>
                        <li>
                            <a href="<?php echo Yii::app()->createUrl('feedback/create') ?>">Novo Pagamento</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li>
                            <a href="<?php echo Yii::app()->createUrl('feedback/create') ?>">Nova Opinião</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
