...
<div class="form-group">
    <div class="btn-group">
        ...
        <?php echo $form->radioButton($model, 'for_arrenda', array('class' => "prettyradio", 'uncheckValue' => null, 'name' => 'sType', 'value' => 'for_arrenda')); ?>
        <?php echo $form->label($model, 'for_arrenda'); ?>

        <?php echo $form->radioButton($model, 'for_sale', array('class' => "prettyradio", 'uncheckValue' => null, 'checked' => 'checked', 'name' => 'sType', 'value' => 'for_sale')); ?>
...
<div class="rentAttr">
    <div class="form-group">
        ...
        <?php echo $form->textField($model, 'inicio', array('placeholder' => 'De', 'size' => 8, "class" => "form-control datepick", 'value' => $model->inicio)); ?>
        <?php echo $form->label($model, 'fim'); ?>
        <?php echo $form->textField($model, 'fim', array('placeholder' => 'De', 'size' => 8, "class" => "form-control datepick datepickEnd", 'value' => $model->fim)); ?>
