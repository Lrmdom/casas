<div class="container-fluid">
    <div class="col-xs-12 col-sm-6 colmd-6 col-lg-6">
        <?php if (isset($cod_casa)): ?>
            <h4><?php echo Yii::t("content", "Criar Reserva") . Yii::t("content", " casa ") . $cod_casa ?></h4>
            <?php
    ...
    <div class="col-xs-12 col-sm-6 colmd-6 col-lg-6">
        ...
        $form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => Yii::app()->createUrl('reserva/new'),
        ));
        ?>
        ...
        <div class="form-group">
            ...
            <?php echo $form->hiddenField($model, 'promo', array('type' => "text", 'value' => 0)); ?>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#Preco_cod_casa').change(function() {
                window.location = '<?php echo $this->createUrl("reserva/newCasa") ?>' + '/' + $(this).val();
